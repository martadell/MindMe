...
public class EditFolderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText editText = (EditText) findViewById(R.id.edit_nom);
        editText.setText(llistacat.get(1).getImatge().toString());

        ImageView im = (ImageView) findViewById(R.id.icon_cat);


       /* String fileP =llistacat.get(1).getImatge().toString();
        File filePath = getFileStreamPath(fileP);
